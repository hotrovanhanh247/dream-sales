...
// Startup diagnostics — visible in Railway logs before any validation crash
console.log('[Config] NODE_ENV:', nodeEnv);
console.log('[Config] PORT:', process.env.PORT || '(not set, default 8080)');
...
const WEAK_JWT_DEFAULTS = ['change-this-secret', 'dev-only-change-in-prod', 'secret'];
...
const config = {
  ...
  // Combo unit price — used by breakaway fee tiers (revenue → combo count).
